...
public class LightningChargerContainer extends Container {
    ...
    public LightningChargerContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        if (tileEntity != null) {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                ...
                addSlot(new SlotItemHandler(h, 2, 58, 42));
            });
        }
    }
    ...
    public boolean stillValid(PlayerEntity pPlayer) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()), pPlayer, ModBlocks.LIGHTNING_CHARGER.get());
    }
