package com.itskillerluc.firstmod.world.structure.structures;
...
public class TempleStructure extends Structure<NoFeatureConfig> {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return TempleStructure.Start::new;
    }
        ...
        public void generatePieces(DynamicRegistries dynamicRegistries, ChunkGenerator chunkGenerator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome, NoFeatureConfig config) {
            ...
            JigsawManager.addPieces(dynamicRegistries,
                    new VillageConfig(() -> dynamicRegistries.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(new ResourceLocation(firstmod.MOD_ID, "temple/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "temple at " +
