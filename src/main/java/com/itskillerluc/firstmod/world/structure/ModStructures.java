package com.itskillerluc.firstmod.world.structure;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import com.itskillerluc.firstmod.firstmod;
import com.itskillerluc.firstmod.world.structure.structures.TempleStructure;
...
public class ModStructures {
    public static DeferredRegister<Structure<?>> STRUCTURES = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, firstmod.MOD_ID);

    public static RegistryObject<Structure<NoFeatureConfig>> TEMPLE = STRUCTURES.register("temple", TempleStructure::new);
